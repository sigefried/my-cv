...
\phone[mobile]{+4915157012359}                   % optional, remove / comment the line if not wanted; the optional "type" of the phone can be "mobile" (default), "fixed" or "fax"
...
\cventry{August 2020--Present}{Software Engineer}{Google}{Munich German}{}{
  \begin{itemize}
...
\cventry{August 2020--Present}{Next-generation phone to vehicle
...
\cvlistitem{In-depth experience and knowledge of open source softwares: Kafka, Elastic Search, Hadoop, Spark.}
\cvlistitem{Good experience with using Google Cloud.}
\cvlistitem{Programming languages: C/C++, Java, Python, Assembly, Golang, Ruby/Rails.}
